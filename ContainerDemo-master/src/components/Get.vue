    ...
    <div v-if="showWarning">
      <md-card class="my-card" md-with-hover>
        <md-ripple>
          ...
          <md-card-content>
            You need to select a party to begin
          </md-card-content>
    ...
    <div v-if="showTracking">
      ...
      <md-table class="audit-table md-layout-item md-size-70 md-large-size-70 md-medium-size-80 md-small-size-90 md-xsmall-size-100" v-model="searched" md-sort="name" md-sort-order="asc" md-fixed-header>
        <md-table-toolbar>
          ...
          <div>Record of Child Support Payments</div>
          <md-button class="md-raised md-primary" :to="{name: 'Home'}"><strong>Back</strong></md-button>
        ...
        <md-table-row slot="md-table-row" v-for="(se, i) in searched" :key="i">
          ...
          <md-table-cell md-label="Username" md-sort-by="payload.method">Kyle</md-table-cell>
          <md-table-cell md-label="Amount" md-sort-by="payload.inputs.inventoryType">{{ se.payload.inputs.amount }}</md-table-cell>
          <md-table-cell md-label="Last Four" md-sort-by="payload.inputs.inventoryQty">{{ se.payload.inputs.payee }}</md-table-cell>
